...
• f_data_entry.h/f_data_entry.с - файлы, содержащие описанием функций работы со входными данными

• f_database.h/f_database.с - файлы, содержащие описанием функций работы со списками: добаление, удаление, поиск элемента и очистка, вывод на экран списков.

• f_database_file.h/f_database_file.с - файлы, содержащие описанием функций работы с файлами: чтение из файла, сохранение в файл
